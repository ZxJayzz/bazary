        ...
        <div className="md:col-span-2">
          ...
          <div className="flex items-center gap-2 mb-4">
            <button
              ...
              className="flex items-center justify-center gap-1.5 flex-1 px-3 py-2 bg-[#1877F2] text-white rounded-lg text-xs font-medium hover:bg-[#166FE5] transition-colors"
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 flex-1 px-3 py-2 bg-[#25D366] text-white rounded-lg text-xs font-medium hover:bg-[#20BD5A] transition-colors"
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 flex-1 px-3 py-2 bg-gray-100 text-gray-700 rounded-lg text-xs font-medium hover:bg-gray-200 transition-colors"
              ...
              {showPhone ? (
                <div className="flex gap-2">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 flex-1 px-4 py-3 bg-primary text-white rounded-xl font-medium hover:bg-primary-hover transition-colors"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    href={`https://wa.me/${product.user.phone.replace(/[^0-9+]/g, "").replace(/^\+/, "")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 px-4 py-3 bg-[#25D366] text-white rounded-xl font-medium hover:bg-[#20BD5A] transition-colors"
